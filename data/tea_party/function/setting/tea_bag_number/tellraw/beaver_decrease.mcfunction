# tea_party:setting/tea_bag_number/tellraw/beaver_decrease
#
...
# スコア減算
scoreboard players remove #beaver tea.tea_bag_number 1
scoreboard players operation #beaver tea.tea_bag_number > #0 tea.int
