# tea_party:setting/tea_bag_number/tellraw/eleanor_decrease
#
...
# スコア減算
scoreboard players remove #eleanor tea.tea_bag_number 1
scoreboard players operation #eleanor tea.tea_bag_number > #0 tea.int
execute store result storage tea_party: tea_bags.count.eleanor int 1 run scoreboard players get #eleanor tea.tea_bag_number
