...
tellraw @s ["　 ",{text:" －",color:"dark_red",click_event:{action:"run_command",command:"/function tea_party:setting/role/tellraw/special_agent_decrease"}},{text:"  "},{score:{name:"#special_agent",objective:"tea.use_role"}},{text:"　＋",color:"aqua",click_event:{action:"run_command",command:"/function tea_party:setting/role/tellraw/special_agent_increase"}},{text:"　マサチューセッツ植民地総督直属工作員",bold:true,italic:true,color:"dark_red"}]
tellraw @s ["　 ",{text:" －",color:"dark_red",click_event:{action:"run_command",command:"/function tea_party:setting/role/tellraw/sam_decrease"}},{text:"  "},{score:{name:"#sam",objective:"tea.use_role"}},{text:"　＋",color:"aqua",click_event:{action:"run_command",command:"/function tea_party:setting/role/tellraw/sam_increase"}},{text:"　(未実装)サミュエル・アダムズ(占い師)",bold:true,italic:true,color:"green"}]
