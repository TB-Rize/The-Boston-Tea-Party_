...
tellraw @s ["　 ",{text:" －",color:"dark_red",click_event:{action:"run_command",command:"/function tea_party:setting/role/tellraw/decrease {roleName:'dopagaki'}"}},{text:"  "},{score:{name:"#dopagaki",objective:"tea.use_role"}},{text:"　＋",color:"aqua",click_event:{action:"run_command",command:"/function tea_party:setting/role/tellraw/increase {roleName:'dopagaki'}"}},{text:"　ドパガキ",bold:true,italic:true,color:"yellow"}]
