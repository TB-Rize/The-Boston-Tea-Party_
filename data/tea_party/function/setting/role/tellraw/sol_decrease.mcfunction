# tea_party:setting/role/tellraw/sol_decrease
# ゴミ
...
# 役職数を1減らす
scoreboard players remove #sons_of_liberty tea.use_role 1
scoreboard players operation #sons_of_liberty tea.use_role > #0 tea.int
# 設定の続きをさせる
