# tea_party:setting/role/tellraw/special_agent_decrease
#
...
# 役職数を1減らす
scoreboard players remove #special_agent tea.use_role 1
scoreboard players operation #special_agent tea.use_role > #0 tea.int
# 設定の続きをさせる
